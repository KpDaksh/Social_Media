#!/usr/bin/env node
// Usage:
//   node scripts/set-cors.js --bucket your-bucket-name --key /path/to/service-account.json
...
async function main() {
  ...
  if (!bucketName) {
    console.error('Bucket name must be provided via --bucket or VITE_FIREBASE_STORAGE_BUCKET in .env')
    process.exit(1)
  }
